    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="seller_save_btn">保存</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="sellerUpdateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary" id="seller_update_btn">更新</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".edit_btn", function () {
        ...
        $("#seller_update_btn").click(function () {
            //发送ajax请求保存更新的商家数据
            $.ajax({
                url: "${APP_PATH}/seller/" + $(this).attr("edit-id"),
                type: "PUT",
